...
from docos.services.semantic.skills.high_demand import HIGH_DEMAND_IDS, HighDemandSkill
...
def select_skill(
    ...
    if dt is not None:
        ...
        if dt.id in HIGH_DEMAND_IDS:
            return HighDemandSkill(dt.id, dt.label, dt.category), dt, confidence, signals
