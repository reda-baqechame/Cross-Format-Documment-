...
REGISTRY: tuple[EngineSpec, ...] = (
    ...
    EngineSpec(
        ...
        "safe_core",
        ("pdf_render", "pdf_text"),
        notes="Google PDFium; self-contained wheel.",
    ),
    ...
    EngineSpec(
        ...
        "MPL-2.0",
        "safe_with_conditions",
        ("pdf_encrypt", "pdf_linearize", "pdf_streams"),
        notes="qpdf binding.",
    ),
    EngineSpec(
        "pdfplumber",
    ...
    EngineSpec(
        ...
        "Apache-2.0",
        "safe_core",
        ("ocr", "layout", "tables", "ocr_vl"),
        notes="PaddleOCR / PaddleOCR-VL.",
    ),
    EngineSpec(
        "docling",
        "docling",
        "MIT",
        "safe_core",
        ("parse", "layout", "tables", "reading_order"),
        notes="IBM Docling.",
    ),
    EngineSpec(
        "olmocr",
        ...
        "safe_core",
        ("ocr", "pdf_to_markdown"),
        integration_mode="model",
        notes="AllenAI olmOCR-2; weights downloaded at runtime.",
    ),
    EngineSpec(
        "qwen2.5-vl",
        None,
    ...
    EngineSpec(
        ...
        ("ocr_vl",),
        integration_mode="model",
        notes="GOT-OCR 2.0 weights (Apache-2.0).",
    ),
    EngineSpec(
        "magika",
        "magika",
        ...
        ("file_type_detection",),
        integration_mode="model",
        notes="Google Magika; small bundled model.",
    ),
    ...
    EngineSpec(
        ...
        ("embeddings",),
        integration_mode="model",
        notes="ONNX; serves bge-small-en-v1.5 (MIT).",
    ),
    ...
    EngineSpec(
        ...
        "Apache-2.0",
        "safe_core",
        ("sheet_edit", "doc_edit", "slide_edit"),
        integration_mode="service",
        notes="Frontend office SDK (JS).",
    ),
    EngineSpec(
        "onlyoffice",
        None,
    ...
    EngineSpec(
        "surya",
        None,
        "Apache-2.0 (code) / OpenRAIL (weights)",
        "commercial_required",
        ("ocr_vl", "layout"),
        integration_mode="model",
    ...
    EngineSpec(
        ...
        ("pdf_to_markdown",),
        integration_mode="model",
        notes="Commercial self-host license required.",
    ),
)
